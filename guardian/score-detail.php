...
if (!isset($_SESSION['guardian_login'])) {
    ...
    if(isset($_GET['group_id'])){
        ...
        $std_scores = $conn->prepare("SELECT * FROM scores WHERE group_id='$group_id' and std_id='$gd_std'");
        $std_scores->execute();
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5>Score in group: <?php echo $group_id ?>, Season: <?php echo $group['season'] ?>, Year: <?php echo $group['year'] ?></h5>
                        </div>
