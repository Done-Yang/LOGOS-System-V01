...
if (!isset($_SESSION['guardian_login'])) {
    ...
    $gd_std = $guardian_std['std_id'];
    //select group of student study in
    $std_atts = $conn->prepare("SELECT * FROM attendances where std_id='$gd_std' ");
    $std_atts->execute();
}
                                            ...
                                            foreach ($std_atts as $std_att) {
                                                ...
                                                if ($std_att['std_id'] == $gd_std) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="actions ">
                                                                <a href="attendance-detail.php?group_id=<?= $group['group_id'] ?>&semester=<?= $std_att['semester'] ?>&std_id=<?= $gd_std ?>" class="btn btn-sm bg-success-light me-2 ">
