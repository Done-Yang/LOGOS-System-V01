    ...
    if (isset($_GET['id'])) {
        ...
        if (isset($_REQUEST['submit'])) {
            try {
                ...
                $check_tel = $conn->prepare("SELECT tel FROs WHERE tel = :tel AND tel != :this_tel");
                $check_tel->bindParam(":this_tel", $u['tel']);
                $check_tel->bindParam(":tel", $_REQUEST['tel']);
                $check_tel->execute();

                $check_whatsapp = $conn->prepare("SELECT whatsapp FROM officers WHERE whatsapp = :whatsapp AND whatsapp != :this_whatsapp");
                $check_whatsapp->bindParam(":this_whatsapp", $officer['whatsapp']);
                ...
                if (
                    ...
                    language_proficiency=:language_proficiency, talent=:talent, familymatters=:familymatters, plansforthefuture=:plansforthefuture, image=:image WHERE off_id=:off_id";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-control select <?php echo $edu_level1_red_border ?>"
                                                    ...
                                                    <option>Master University</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $edu_branch1_red_border ?>"
                                                    ...
                                                    value="<?php echo $off_row['edu_branch1'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $univ_name1_red_border ?>"
                                                    ...
                                                    value="<?php echo $off_row['univ_name1'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $edu_district1_red_border ?>"
                                                    ...
                                                    value="<?php echo $off_row['edu_district1'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $edu_province1_red_border ?>"
                                                    ...
                                                    value="<?php echo $off_row['edu_province1'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control <?php echo $edu_season1_red_border ?>"
                                                    ...
                                                    value="<?php echo $off_row['edu_season1'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="edu_branch2"
                                                    value="<?php echo $off_row['edu_branch2'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="univ_name2"
                                                    value="<?php echo $off_row['univ_name2'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="edu_district2"
                                                    value="<?php echo $off_row['edu_district2'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="edu_province2"
                                                    value="<?php echo $off_row['edu_province2'] ?>">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="edu_season2"
                                                    value="<?php echo $off_row['edu_season2'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="employment_history"
                                                    value="<?php echo $off_row['employment_history'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <!--New element -->
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="language_proficiency"
                                                    value="<?php echo $off_row['language_proficiency'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <!--New element -->
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="familymatters"
                                                    value="<?php echo $off_row['familymatters'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input class="form-control" type="text" name="plansforthefuture"
                                                    value="<?php echo $off_row['plansforthefuture'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group students-up-files">
                                                <label>Image Profile 3x4cm (<?php echo $off_row['image'] ?>) <span
