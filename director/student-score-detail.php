...
if (!isset($_SESSION['director_login'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        $director_id = $_SESSION['director_login'];
        include "director-datas/director-db.php";
        $user = directorGetUserById($director_id, $conn);
        $director = getDirectorById($director_id, $conn);
        include "director-datas/group-db.php";
        include "director-datas/studentgroup-db.php";
        include "director-datas/student-score-db.php";
        include "director-datas/student-db.php";
        include "director-datas/subject-db.php";
        include "director-datas/score-db.php";
