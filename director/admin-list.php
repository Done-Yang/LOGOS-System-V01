...
if (!isset($_SESSION['director_login'])) {
    ...
    $adm = $conn->prepare("SELECT * FROM users WHERE status='Admin' ");
    $adm->execute();
    $admins = $adm->fetchAll();
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="admin-list.php">Admins</a></li>
                                ...
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="admin-add.php" class="btn btn-primary"><i
                                        ...
                                        <tbody>
                                            ...
                                            <?php } else {
                                                foreach ($admins as $admin) {
                                                    $i++; 
                                                    $officer = getOfficerById($admin['u_id'], $conn);?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                ...
                                                                <a href="officer-detail.php?id=<?= $officer['off_id'] ?>"
                                                                    class="avatar avatar-sm me-2"><img
                                                                        class="avatar-img rounded-circle"
                                                                        src="<?php echo "../admin/upload/officer_profile/$officer_image" ?>"
                                                                        alt="User Image"></a>
                                                                <?php } ?>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="actions ">
                                                                ...
                                                                <a href="admin-delete.php?id=<?= $officer['off_id'] ?>"
                                                                    class="btn btn-sm bg-danger-light"
                                                                    onclick="return confirm('Do you want to change this officer status to Officer?')">
