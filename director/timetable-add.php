...
if (!isset($_SESSION['director_login'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($_REQUEST['group_id'])) {
            ...
            $_SESSION['error'] = "The time table in this group ID is already exist! <a href='score-student-edit.php?group_id=$search_by'>Click here for update</a>";
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <?php echo $days[$j] ?>
                                                                    <input type="hidden"
                                                                        name="<?php echo $addLoop . 'days' ?>"
                                                                        value="<?php echo $days[$j] ?>">
                                                                </td>
                                                                <td class="col-12 col-sm-2">
                                                                    <select class="form-control select"
                                                                        name="<?php echo $addLoop . 'subject1' ?>">
                                                                        <option><?php $subject1 ?></option>
                                                                        <?php
