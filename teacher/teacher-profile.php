                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <p class="col-sm-9"><?php echo $teacher['fname_en'] . ' ' . $teacher['lname_en'] ?></p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Date of Birth</p>
                                                    <p class="col-sm-9"><?php echo $teacher['dob'] ?></p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Email ID</p>
                                                    <p class="col-sm-9"><?php echo $teacher['email'] ?></a></p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Tel</p>
                                                    <p class="col-sm-9"><?php echo $teacher['tel'] ?></p>
                                                </div>
                                                <div class="row">
