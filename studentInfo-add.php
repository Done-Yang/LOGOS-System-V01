...
<?php
    ...
    $tel = $whatsapp = $email = $village_current = $district_current = $province_current = $study_program = $part = $ethnicity = $nation = $religion = $house_unit = $house_no = '';
    ...
    $tel_err = $whatsapp_err = $email_err = $village_current_err = $district_current_err = $province_current_err = $study_program_err = $part_err = $ethnicity_err = $nation_err = $religion_err = $house_unit_err = $house_no_err = '';
    ...
    $study_program_red_border = $part_red_border = $ethnicity_red_border = $nation_red_border = $religion_red_border = $house_unit_red_border = $house_no_red_border = '';
    $highschool_red_border = $season_hsc_red_border =  $village_study_red_border = $district_study_red_border = $province_study_red_border = '';
    
    $id = $_SESSION['studentInfo'];
        ...
        try {
            ...
            if (
                ...
                $sql2 = "UPDATE students SET fname_en=:fname_en, lname_en=:lname_en, gender=:gender, fname_la=:fname_la, lname_la=:lname_la, program=:program, fname_ch=:fname_ch, lname_ch=:lname_ch, 
                        ...
                        talent=:talent, familymatters=:familymatters, plansforthefuture=:plansforthefuture WHERE std_id=:std_id";
                ...
                echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
                            title: 'Success',
                            text: 'Your Infomation Is Added Successfully!',
                            icon: 'success',
                            timer: 5000,
                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Student Register<span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $guardian_tel_red_border ?>" type="text" name="guardian_tel" value="<?php echo $guardian_tel ?>">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control <?php echo $season_hsc_red_border ?>" type="text" name="season_hsc" value="<?php echo $season_hsc ?>">
