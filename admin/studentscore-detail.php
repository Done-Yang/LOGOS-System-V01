...
if (!isset($_SESSION['admin_login'])) {
    ...
    if (isset($_GET['id']) and isset($_GET['season'])) {
        ...
        include "admin-datas/studentscore-db.php";
        ...
        //Select Scores 
        $scores = $conn->prepare("SELECT DISTINCT std_id FROM scores WHERE group_id='$id' and season='$season'");
        $scores->execute();
                        ...
                        <div class="card-body">
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="page-title">Entire Student: <?php echo $count_std_resault ?>, Program: <?php echo $std_group['program'] ?>, Year: <?php echo $std_group['year'] ?>, Part: <?php echo $std_group['part'] ?>, Class: <?php echo $std_group['group_id'] ?> </h3>
                                    </div>
