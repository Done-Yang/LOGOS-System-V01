...
include "admin/include/config/language.php";
...
if (isset($_REQUEST['submit'])) {
    try {
        ...
        if(!empty($familymatters)){
            $familymatters = $_REQUEST['familymatters'];
        }
        if(!empty($plansforthefuture)){
                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            ...
                            <?php if (isset($_SESSION['success'])) { ?>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info"><?php echo $lang['officer_register'] ?>  <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            <label><?php echo $lang['districtEd'] ?>  <span class="login-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-sm-4"> <!--New element -->
                                        <div class="form-group local-forms">
                                            <label><?php echo $lang['houseN'] ?> </label>
