                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-end float-end" id="print-btn">
                                        ...
                                        <button onclick="window.print();" class="btn btn-primary ms-3"><i class="fas fa-print"></i></button>
                                        <a href="studentgroup-add.php?std_g_id=<?= $std_group['group_id'] ?>" class="btn btn-primary ms-3"><i class="fas fa-plus "></i></a>
                                    </div>
                                    <?php } else { ?>
